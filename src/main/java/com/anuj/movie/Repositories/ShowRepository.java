...
public interface ShowRepository extends JpaRepository<Show, Integer> {
    ...
    @Query(value = "select seat_no from show_seats where show_id = :showId and is_available = 1", nativeQuery = true)
    public List<String> findAvailableSeats(@Param("showId") Integer showId);
}
